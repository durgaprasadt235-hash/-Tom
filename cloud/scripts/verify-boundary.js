...
const BANNED_PATTERNS = [
  ...
  'process-supervisor',
  'command-policy',
  // PHASE 1 privileged modules: the local execution/edit/runtime stack.
  // None of these may ever enter the cloud bundle.
  'runtime-intent',
  'terminal-runner',
  'edit-approval-store',
  'patch-validator',
  ...
  "'/tools'",
  '`/tools',
  // Privileged LOCAL endpoints from workspace/server.js. The cloud surface
  // exposes /api/health and /api/status only.
  '"/chat"',
  "'/chat'",
  '"/project"',
  "'/project'",
